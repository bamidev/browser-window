...
obtain the version that _BrowserWindow_ supports, which currently can be v141 or v122 (v141 doesn't work with Windows). Other versions aren't tested and may not work necessarily.
